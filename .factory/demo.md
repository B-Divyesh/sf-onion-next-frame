...
- Sample: six hand-authored 192×192 PNG frames of an original moth-like runner. Frame 3, its canvas, and frame controls open without scrolling.
- Reset: choose **Reset demo** in the demo banner. This restores frame 3 and every layer default.
