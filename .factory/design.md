...
- Review repair, 2026-08-29: the source PNG and all shipped WebP derivatives were rechecked at native resolution. They show only the three runner poses and contain no lettering. The decorative `FRAME STUDY / 03` CSS pseudo-label was removed; useful Previous / Current / Next labels remain semantic HTML beside the image.
